...
import { UserOnboardingService, type OnboardingData } from '@/lib/services/user-onboarding'
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Let's set up your family calendar. First, tell us about your family.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Add the members of your family to get started with personalized scheduling.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <Button
                type="submit"
                className="flex-1"
                disabled={loading || familyData.members.length === 0}
              >
