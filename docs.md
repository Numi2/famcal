...
• Onboarding UX: made submit button async-friendly (shows "Setting up…"), triggers `router.replace('/')` immediately and runs `getUserDb` in background to avoid perceived freeze.
